...
var play3 = function () { // zmiana na 3 graczy
    ...
    document.getElementById("left").innerHTML = "4 graczy";
    document.getElementById("right").innerHTML = "2 graczy";
...
var play4 = function () { //zmiana na 4 graczy
    ...
    document.getElementById("left").innerHTML = "2 graczy";
    document.getElementById("right").innerHTML = "3 graczy";
...
var play2 = function () { //zmiana na 2 graczy
    ...
    document.getElementById("left").innerHTML = "3 graczy";
    document.getElementById("right").innerHTML = "4 graczy";
