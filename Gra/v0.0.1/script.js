//wybór ilości graczy, to będzie zamienione na coś innego, np buttony czy coś
var iloscgraczy = Number(prompt("podaj ilosc graczy [1-4]"));
//pętla zapewniająca że ilsoć graczy to liczba między 1 a 4
while(iloscgraczy!=1&&iloscgraczy!=2&&iloscgraczy!=3&&iloscgraczy!=4){
    iloscgraczy = Number(prompt("podaj ilosc graczy [1-4]"));
}
//usuwanie danych niepotrzebnych graczy z dokumentu
switch(iloscgraczy){
    case 1:
...
async function pytanieevent(pole){
    ...
    if(pole%2==0){
        //event
        //efekt eventu jest losowy, w finalnej wersji będzie on pobrany razem z treścią z odpowiedniego pliku i nie będzie na alercie
